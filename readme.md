...
- Скачать проект;
- перед первым запуском зайти через терминал в папку с проектом и ввести команду "pod install", чтобы установить зависимости;
...
Стек: UICollectionView, SPM, Cocoapods, CoreData, Snapshot tests, MVVM, Localization
